...
const AboutUs = () => {
  ...
  <div className="mission-width-style">
  <div className="mission-style-img" > 
<img className="cashma-img-mission" loading="lazy"
   srcset={img}
...
<div className="special-our_content special-our_content-template--21826586313000__a74be53d-8cc9-4de9-a441-072ee071739e">
    <div className="special-our-heading_style">      
      <h2 className="special-our-about-page">
          Our Specials
      </h2>
      <p>
        Our commitment to your vision and satisfaction remains unwavering, no matter how you connect with us.
      </p>
    </div>
  ...
  <div className="special-our-image_style">
    ...
    <div className="special-our_img_text">
      ...
      <img className="special-our-section-desk" loading="lazy"
        ...
        <img className="special-our-section-mob" loading="lazy"
