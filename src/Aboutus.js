        ...
        <div className='gradient-bg'>
            <div className="about-container">
                ...
                <div className="vision-section">
                    <h2>OUR VISION</h2>
                    <p>We believe ‘it's all about you, your vibe, your tribe, your energy & your panache’. You are special and you deserve the best in eyewear; and what you choose at ‘Polish Eyewear’ becomes your style.</p>
                </div>
                <div className="vision-section">
                    <h2>OUR MISSION</h2>
                    <p>"Our mission at POLISH Eyewear is to provide unparalleled clarity, comfort, and style through our range of premium eyewear products. We are dedicated to enhancing the vision and lifestyle of our customers by offering innovative optical solutions crafted with precision and care.</p>
                </div>
            </div>
        </div>
    );
